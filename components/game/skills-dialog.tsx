...
export default function SkillsDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto z-200">
        <DialogHeader>
          <DialogTitle>Skills Management</DialogTitle>
          <DialogDescription>
            Manage your skills and create new ones. You have {skills.length}/
            {availableSlots} skill slots used.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <div className="flex items-center gap-4 text-sm">
                        <span className="text-muted-foreground">
                          Base Damage: {skill.base_damage}
                        </span>
                        <span className="text-muted-foreground">
                          Slot: {skill.slot_number}
                        </span>
                      </div>
                    </CardContent>
                  </Card>
          ...
          <div className="space-y-3">
            ...
            {!hasAvailableSlots && (
              <p className="text-sm text-muted-foreground">
                You have no available skill slots. Gain more through progression
                ...
                <CardContent className="pt-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setNewSkill({ ...newSkill, element: value })
                      }
                    >
                  ...
                  <p className="text-xs text-muted-foreground">
                    All skills start with 10 base damage. Damage is modified by
                    equipment and combat situations.
                  </p>
